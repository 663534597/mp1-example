...
/**
 * This is the property specification used to activate a profile. If the value field is empty, then the existence of the named property will activate the profile, otherwise it does
 * a case-sensitive match against the property value as well.
 * @version $Revision$ $Date$
 */
@SuppressWarnings("all")
public class ActivationProperty implements java.io.Serializable, java.lang.Cloneable, com.example.io.InputLocationTracker {
