...
public class Scm implements java.io.Serializable, java.lang.Cloneable, com.example.io.InputLocationTracker {
	...
	/**
	 * The source control management system URL that describes the repository and how to connect to the repository. For more information, see the
	 * <a href="https://maven.apache.org/scm/scm-url-format.html">URL format</a> and <a href="https://maven.apache.org/scm/scms-overview.html">list of supported SCMs</a>. This
	 * connection is read-only. <br>
	...
	/**
	 * Get the source control management system URL that describes the repository and how to connect to the repository. For more information, see the
	 * <a href="https://maven.apache.org/scm/scm-url-format.html">URL format</a> and <a href="https://maven.apache.org/scm/scms-overview.html">list of supported SCMs</a>. This
	 * connection is read-only. <br>
	 * <b>Default value is</b>: parent value [+ path adjustment] + (artifactId or <code>project.directory</code> property).
	 * @return String
	...
	/**
	 * Get the URL to the project's browsable SCM repository, such as ViewVC or Fisheye. <br>
	 * <b>Default value is</b>: parent value [+ path adjustment] + (artifactId or <code>project.directory</code> property).
	 * @return String
	 */
	...
	/**
	 * Set just like <code>connection</code>, but for developers, i.e. this scm connection will not be read only. <br>
	 * <b>Default value is</b>: parent value [+ path adjustment] + (artifactId or <code>project.directory</code> property).
	...
	/**
	 * Set the URL to the project's browsable SCM repository, such as ViewVC or Fisheye. <br>
	 * <b>Default value is</b>: parent value [+ path adjustment] + (artifactId or <code>project.directory</code> property).
	 * @param url
	 */
