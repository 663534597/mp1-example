...
public class PluginExecution extends ConfigurationContainer implements java.io.Serializable, java.lang.Cloneable {
	...
	/**
	 * The priority of this execution compared to other executions which are bound to the same phase. <strong>Warning:</strong> This is an internal utility property that is only
	 * public for technical reasons, it is not part of the public API. In particular, this property can be changed or deleted without prior notice.
	 */
	...
	/**
	 * Get the build lifecycle phase to bind the goals in this execution to. If omitted, the goals will be bound to the default phase specified by the plugin.
	 * @return String
	 */
	...
	/**
	 * Get the priority of this execution compared to other executions which are bound to the same phase. <strong>Warning:</strong> This is an internal utility property that is
	 * only public for technical reasons, it is not part of the public API. In particular, this property can be changed or deleted without prior notice.
	 * @return int
	 */
	...
	/**
	 * Set the build lifecycle phase to bind the goals in this execution to. If omitted, the goals will be bound to the default phase specified by the plugin.
	 * @param phase
	 */
	...
	/**
	 * Set the priority of this execution compared to other executions which are bound to the same phase. <strong>Warning:</strong> This is an internal utility property that is
	 * only public for technical reasons, it is not part of the public API. In particular, this property can be changed or deleted without prior notice.
	 * @param priority
	 */
