...
public class Model extends ModelBase implements java.io.Serializable, java.lang.Cloneable {
	...
	/**
	 * The location of the parent project, if one exists. Values from the parent project will be the default for this project if they are left unspecified. The location is given as
	 * a group ID, artifact ID and version.
	 */
	private Parent parent;

	/**
	 * A universally unique identifier for a project. It is normal to use a fully-qualified package name to distinguish it from other projects with a similar name (eg.
	 * <code>org.apache.maven</code>).
	 */
	private String groupId;

	/**
	 * The identifier for this artifact that is unique within the group given by the group ID. An artifact is something that is either produced or used by a project. Examples of
	 * artifacts produced by Maven for a project include: JARs, source and binary distributions, and WARs.
	 */
	...
	/**
	 * The type of artifact this project produces, for example <code>jar</code> <code>war</code> <code>ear</code> <code>pom</code>. Plugins can create their own packaging, and
	 * therefore their own packaging types, so this list does not contain all possible types.
	 */
	...
	/**
	 * A detailed description of the project, used by Maven whenever it needs to describe the project, such as on the web site. While this element can be specified as CDATA to
	 * enable the use of HTML tags within the description, it is discouraged to allow plain text representation. If you need to modify the index page of the generated web site, you
	 ...
	 * <b>Default value is</b>: parent value [+ path adjustment] + (artifactId or <code>project.directory</code> property) .
	 */
	private String url;
	...
	/**
	 * This element describes various attributes of the organization to which the project belongs. These attributes are utilized when documentation is created (for copyright
	 * notices and links).
	 */
	...
	/**
	 * Get the identifier for this artifact that is unique within the group given by the group ID. An artifact is something that is either produced or used by a project. Examples
	 * of artifacts produced by Maven for a project include: JARs, source and binary distributions, and WARs.
	 * @return String
	 */
	...
	/**
	 * Get a detailed description of the project, used by Maven whenever it needs to describe the project, such as on the web site. While this element can be specified as CDATA to
	 * enable the use of HTML tags within the description, it is discouraged to allow plain text representation. If you need to modify the index page of the generated web site, you
	 * are able to specify your own instead of adjusting this text.
	 * @return String
	 */
	...
	/**
	 * Get a universally unique identifier for a project. It is normal to use a fully-qualified package name to distinguish it from other projects with a similar name (eg.
	 * <code>org.apache.maven</code>).
	 * @return String
	 */
	...
	/**
	 * Get this element describes various attributes of the organization to which the project belongs. These attributes are utilized when documentation is created (for copyright
	 * notices and links).
	 * @return Organization
	 */
	...
	/**
	 * Get the type of artifact this project produces, for example <code>jar</code> <code>war</code> <code>ear</code> <code>pom</code>. Plugins can create their own packaging, and
	 * therefore their own packaging types, so this list does not contain all possible types.
	 * @return String
	 */
	...
	/**
	 * Get the location of the parent project, if one exists. Values from the parent project will be the default for this project if they are left unspecified. The location is
	...
	/**
	 * Get the URL to the project's homepage. <br>
	 * <b>Default value is</b>: parent value [+ path adjustment] + (artifactId or <code>project.directory</code> property).
	 * @return String
	 */
	...
	/**
	 * Set the identifier for this artifact that is unique within the group given by the group ID. An artifact is something that is either produced or used by a project. Examples
	 * of artifacts produced by Maven for a project include: JARs, source and binary distributions, and WARs.
	 * @param artifactId
	 */
	...
	/**
	 * Set a detailed description of the project, used by Maven whenever it needs to describe the project, such as on the web site. While this element can be specified as CDATA to
	 * enable the use of HTML tags within the description, it is discouraged to allow plain text representation. If you need to modify the index page of the generated web site, you
	 * are able to specify your own instead of adjusting this text.
	 * @param description
	 */
	...
	/**
	 * Set a universally unique identifier for a project. It is normal to use a fully-qualified package name to distinguish it from other projects with a similar name (eg.
	 * <code>org.apache.maven</code>).
	 * @param groupId
	 */
	...
	/**
	 * Set this element describes all of the licenses for this project. Each license is described by a <code>license</code> element, which is then described by additional elements.
	 * Projects should only list the license(s) that applies to the project and not the licenses that apply to dependencies. If multiple licenses are listed, it is assumed that the
	...
	/**
	 * Set this element describes various attributes of the organization to which the project belongs. These attributes are utilized when documentation is created (for copyright
	 * notices and links).
	 * @param organization
	 */
	...
	/**
	 * Set the type of artifact this project produces, for example <code>jar</code> <code>war</code> <code>ear</code> <code>pom</code>. Plugins can create their own packaging, and
	 * therefore their own packaging types, so this list does not contain all possible types.
	 * @param packaging
	 */
	...
	/**
	 * Set the location of the parent project, if one exists. Values from the parent project will be the default for this project if they are left unspecified. The location is
	 * given as a group ID, artifact ID and version.
	 * @param parent
	 */
	...
	/**
	 * Set the URL to the project's homepage. <br>
	 * <b>Default value is</b>: parent value [+ path adjustment] + (artifactId or <code>project.directory</code> property).
	 * @param url
	 */
	 ...
	 * @return The POM file from which this model originated or {@code null} if this model does not belong to a local project (e.g. describes the metadata of some artifact from the
	 *         repository).
	 */
	 ...
	 * @return The base directory for the corresponding project or {@code null} if this model does not belong to a local project (e.g. describes the metadata of some artifact from
	 *         the repository).
	 */
